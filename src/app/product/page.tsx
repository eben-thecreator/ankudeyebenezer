...
export default async function ProductPage() {
  ...
  const res = await fetch(`${baseUrl}/data/product.json`, { cache: 'no-store' });
    ...
    <main className="w-full">
      ...
      <section className="relative w-full h-96 overflow-hidden bg-black">
        ...
        <div className="relative z-10 h-full flex flex-col items-start justify-end px-6 sm:px-12 pb-12">
          <h1 className="text-5xl sm:text-6xl font-extrabold text-white mb-3">PRODUCT & BRAND</h1>
          <p className="text-lg text-gray-300 max-w-2xl">End-to-end product design and brand systems that align strategy, experience and visual identity.</p>
        </div>
      </section>
